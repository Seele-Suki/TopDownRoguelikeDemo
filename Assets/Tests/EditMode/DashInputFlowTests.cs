...
{
    public sealed class DashInputFlowTests
    {
        ...
        [Test]
        public void ApplyInputState_StoresDashRequestSequence()
        {
            Component remoteInput =
                CreateComponent(
                    RemoteInputTypeName,
                    "Remote Dash Input Test",
                    out GameObject inputObject);

            try
            {
                MethodInfo applyMethod =
                    FindApplyInputStateMethod(
                        remoteInput.GetType());
        ...
        [Test]
        public void Advance_PublishesDashRequestSequence()
        {
            Component publisher =
                CreateComponent(
                    PublisherTypeName,
        ...
        [Test]
        public void HandleRemotePlayerInput_AppliesDashSequence()
        {
            Type registryType =
        ...
        private static MethodInfo FindApplyInputStateMethod(
            Type remoteInputType)
        {
            return remoteInputType.GetMethod(
                "ApplyInputState",
                new[]
                {
                    typeof(Vector2),
